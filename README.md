...
- `journal.html` — append-only, auto-written session-by-session log
- `about.html` / `faq.html` — the experiment's story and honest Q&A
...
- `robots.txt`, `sitemap.xml`, `404.html`, `ads.txt` — SEO/ads infrastructure
